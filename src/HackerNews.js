...
export default function HackerNews() {
    ...
    return (
        <div className="container max-w-md mx-auto p-4 bg-purple shadow-lg rounded">
            ...
            <form onSubmit={handleSearch} className="mb-2">
                <input type="text" onChange={event => setQuery(event.target.value)} value={query} ref={searchInputRef} className="border p-1 rounded"></input>
                <button type="submit" className="bg-orange rounded m-1 p-1">Search</button>
                <button type="button" onClick={handleClearSearch} className="bg-teal  p-1 rounded">Clear</button>
            </form>
            {
